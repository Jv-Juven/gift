...
class ElectionController extends BaseController{
	...
	public function select()
	{
		...
		$gifts = Gift::where('title', 'like', '%'.$word.'%')->get();
		// if(Request::ajax())
		// {
			if(count($gifts) == 0)
			{
	...
	public function price()
	{
		...
		$gifts = Gift::whereBetween('price', array($low_price, $high_price))->get();
	...
	public function scene()
	{
		...
		$gifts = Gift::where('scene_id','=', $scene_id)->get();
	...
	public function charactor()
	{
		...
		$gifts = Gift::where('charactor_id','=', $charactor_id)->get();
	...
	public function object()
	{
		...
		if(!isset($object_id))
			return Response::json(array('errCode'=>1, 'message'=>'请选择个性类型！'));
		$gifts = Gift::where('object_id','=', $object_id)->get();
