    ...
    <div class="container clearfix">
        <div class="topic-wrap">
            <div class="topic">
                ...
                <div class="info">
                    <span class="view">
                        <img src="/images/pc/topic/icon-view.png" alt="" class="icon">
                        <span class="num" id="count-view">15</span>
                    </span>
                    <span class="comment">
                        <img src="/images/pc/topic/icon-comment.png" alt="" class="icon">
                        <span class="num" id="count-comment">20</span>
                    </span>
                    <span class="like">
                        <img src="/images/pc/topic/icon-like.png" alt="" class="icon">
